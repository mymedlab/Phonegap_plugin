...
var app = {
    ...
    storeToken: function(token) {
        ...
        window.devToken=token;
        /*
        console.log("Token is " + token);
        console.log("Token is " + window.devToken);
        var xmlhttp=new XMLHttpRequest();
        xmlhttp.overrideMimeType("application/json");
       // request.open("GET", "https://66.228.51.14/calls/token?client="+name, true);
        xmlhttp.open("GET","https://66.228.51.14/calls/token?client=ginter&device_token="+token,true);

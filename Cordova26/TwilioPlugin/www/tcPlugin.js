...
function onDeviceReady() {
  $(document).on('click', '#login', loginButtonFunc);
  $(document).on('click', '#mute', onMuteButton);
  $(document).on('click', '#unmute', onUnMuteButton);
  $(document).on('click', '#status', onStatusButton);
  $(document).on('click', '#hangup', onDisconnectButton);
  $(document).on('click', '#call', verifyNumberFunc);
